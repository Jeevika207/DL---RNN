...
STEP 1:
Load the dataset, create word-to-index and tag-to-index mappings, and group words into sentences.

STEP 2:
Convert sentences into numerical index sequences, apply padding to make all sequences equal length, and split the data into training and testing sets.

STEP 3:
Define a custom dataset class and use a DataLoader to handle batching of data.

STEP 4:
Build a Bidirectional LSTM model suitable for sequence labeling tasks.

STEP 5:
Train the model over multiple epochs while monitoring the loss.

STEP 6:
Evaluate the model performance, plot loss curves, and visualize predictions on sample text.
